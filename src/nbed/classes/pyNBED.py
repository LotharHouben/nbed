...
class pyNBED:
    ...
    def __filterpeaklist(self, framepeaklist,refine=False, massthresh=None, qrange=None):
    ...
    def DebyeScherrerPlot(self, framepeaklist,refine=False, massthresh=None, qrange=None):
    ...
    def PeakDistanceHistogram(self, framepeaklist, refine=True, massthresh=None, qrange=None):
    ...
    def VirtualApertureImage(self, radius=[0,10], offset=None, invert=False, mode=None):
