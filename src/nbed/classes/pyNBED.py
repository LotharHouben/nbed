...
class pyNBED:
    ...
    def LinearIndexArray(self, cols, rows, is_roi=True):
        ...
        the x-coordinate is res // self.dim[0]
        the y-coordinate is res % self.dim[0]
    ...
    def PeakDetection(self, idxarray, params=None, animate=True, raw=False):        
        ...
        idxarray:   list of spatial pixel indices in linear order
                    (output of class method LinearIndexArray())
    ...
    def PeakDistanceHistogram(self,framepeaklist, refine=True):
